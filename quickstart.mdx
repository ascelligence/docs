...
<Steps>
  <Step title="Step 1: Add Your Domain to Kyvic" titleSize="h2">
    ...
    When adding your domain, you must tell Kyvic where your origin server is located. Enter your origin server's IP address (e.g., `123.45.67.89`) or an existing hostname (e.g., `my-server-origin.com`).
