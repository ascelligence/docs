...
| :-------------------------------------------------------- | :----------------------- | :------------------------------------------------------------------------------------------------------------------ |
| **Self-Hosted Websites** (e.g, WordPress, Joomla)         | ✅ **Yes**                | You have full DNS control to point your domain to Kyvic.                                                            |
| **Cloud & VPS Hosting** (e.g, AWS, DigitalOcean, Hetzner) | ✅ **Yes**                | Ideal use case. You have complete control over your domain and server infrastructure.                               |
| **Managed Blogs** (e.g, Wordpress.com)                    | ✅ **Yes\***              | Our specific setup guide for managed platforms is required.                                                         |
| **Managed Website Builders** (e.g, Squarespace)           | ✅ **Yes\***              | Our specific setup guide for managed platforms is required.                                                         |
| **Managed E-commerce Platforms** (e.g, Shopify)           | ✅ **Yes\***              | Our specific setup guide for managed platforms is required.                                                         |
...
<Note>
  **A Note on Managed Platforms (Shopify, Wix, etc.)**

  With managed platforms, you don’t have direct control over firewalls like you would with self-hosted servers. That’s why we use the “secret subdomain” method as the main way to protect against bypass attempts (see our _Quickstart Guide for Managed Platforms_). Keep in mind that this setup depends on the platform’s rules, which can change, but Kyvic will work with you to keep everything running smoothly.
</Note>
