...
<Note>
  **Note on DDoS Protection:**
  ...
  Our infrastructure provides built-in protection against large-scale network floods (L3/4 DDoS). For more sophisticated application-layer (L7) attacks, we recommend a layered defense using your own origin firewall (WAF), just be sure to whitelist our IP ranges. Please note that all traffic we process is counted towards your usage. See our Quickstart Guide for configuration details.
</Note>