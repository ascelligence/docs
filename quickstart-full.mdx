...
description: "Follow these steps to protect your self-hosted website or application 🛡️. This guide is for users with full server or firewall control."
---
...
<Steps>
  ...
  <Step title="Step 5 (Recommended): Use Relative Paths for All Internal Resources" stepNumber={5} titleSize="h2">
